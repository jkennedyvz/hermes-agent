...
class TestToolsetIntegration:
    def test_homeassistant_toolset_resolves(self):
        ...
        assert set(tools) == {"ha_list_entities", "ha_get_state", "ha_call_service", "ha_list_services", "ha_get_history", "ha_get_camera_image"}

    def test_gateway_toolset_includes_ha_tools(self):
        from toolsets import resolve_toolset

        gateway_tools = resolve_toolset("hermes-gateway")
        for tool in ("ha_list_entities", "ha_get_state", "ha_call_service", "ha_list_services", "ha_get_history", "ha_get_camera_image"):
